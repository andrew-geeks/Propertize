...
function MaintainProp(){
    ...
    items.map(item=>{
      propData.p_id = item._id
      propData.p_name = item.p_name
      return ""
    })
    const formData = {p_id:propid,u_id:uid,m_date:"2023-03-27",m_type:"",priority:"",description:""}
    ...
    return(
        <section>
                ...
                <h3 style={{"text-align":"center"}}>Maintain {propData.p_name}🏠🛠️</h3>
